export type AnchorSola = {
  ...
  accounts: [
    ...
    {
      name: "badgeState";
      docs: ['seeds: "badge_state" + badge_mint'];
      type: {
        kind: "struct";
        fields: [
          {
    ...
    {
      name: "lineageOrigins";
      docs: ['seeds: "lineage_origins" + badge_mint'];
      type: {
        kind: "struct";
        fields: [
          {
    ...
    {
      name: "genericOrigins";
      docs: ['seeds: "generic_origins" + badge_mint'];
      type: {
        kind: "struct";
        fields: [
          {
    ...
    {
      name: "solaProfile";
      docs: ["和spl的Mint关联", "", 'seeds: "sola_profile" + master_mint'];
      type: {
        kind: "struct";
        fields: [
          {
            name: "profileId";
            docs: ["初始计数器，后续作为token id来使用"];
            type: {
              array: ["u8", 8];
            };
          },
    ...
    {
      name: "tokenClass";
      docs: ['seeds: "token_class" + class_id'];
      type: {
        kind: "struct";
        fields: [
          {
    ...
    {
      name: "classGeneric";
      docs: ['seeds: "class_generic" + token_calss.key().as_ref()'];
      type: {
        kind: "struct";
        fields: [
          {
